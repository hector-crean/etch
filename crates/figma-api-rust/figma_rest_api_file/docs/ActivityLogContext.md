...
------------ | ------------- | ------------- | -------------
**client_name** | Option<**String**> | The third-party application that triggered the event, if applicable. | 
...
**team_id** | Option<**String**> | The id of the team where the event took place -- if this took place in a specific team. | 
