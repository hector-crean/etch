...
impl WebhookV2 {
    ...
    pub fn new(id: String, event_type: models::WebhookV2Event, team_id: String, context: String, context_id: String, plan_api_id: String, status: models::WebhookV2Status, client_id: Option<String>, passcode: String, endpoint: String, description: Option<String>) -> WebhookV2 {
        WebhookV2 {
            id,
            event_type,
            team_id,
