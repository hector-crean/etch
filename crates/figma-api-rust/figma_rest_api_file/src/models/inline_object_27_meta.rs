...
impl InlineObject27Meta {
    pub fn new(variables: std::collections::HashMap<String, models::PublishedVariable>, variable_collections: std::collections::HashMap<String, models::PublishedVariableCollection>) -> InlineObject27Meta {
        InlineObject27Meta {
            variables,
