use crate::codegen_ext::SvgContainerMode;
...
impl SvgContainerAnalyzer {
    ...
    pub fn should_wrap_in_svg(
        analysis: &ContainerAnalysis,
        mode: SvgContainerMode,
    ) -> bool {
        match mode {
...
mod tests {
    use super::*;
    use figma_api::models::{VectorNode, TextNode, GroupNode};
    ...
    fn test_should_wrap_wrap_all() {
        ...
        assert!(SvgContainerAnalyzer::should_wrap_in_svg(&analysis, SvgContainerMode::WrapAll));
    }
    ...
    fn test_should_wrap_mixed() {
        ...
        assert!(SvgContainerAnalyzer::should_wrap_in_svg(&analysis, SvgContainerMode::Mixed));
        ...
        assert!(!SvgContainerAnalyzer::should_wrap_in_svg(&mixed_analysis, SvgContainerMode::Mixed));
    }
    ...
    fn test_configurable_decision() {
        ...
        assert!(SvgContainerAnalyzer::should_wrap_in_svg(&all_vectors, SvgContainerMode::Configurable));
        ...
        assert!(!SvgContainerAnalyzer::should_wrap_in_svg(&no_vectors, SvgContainerMode::Configurable));
        ...
        assert!(SvgContainerAnalyzer::should_wrap_in_svg(&vector_dominated, SvgContainerMode::Configurable));
    }
}
