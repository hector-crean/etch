...
impl CodeGenerator<HtmlVisitor> for HtmlGenerator {
    fn generate(&self, visitor: &HtmlVisitor) -> Result<CodeGenResult, Box<dyn std::error::Error>> {
...
impl HtmlGenerator {
    ...
    fn generate_separate_files(&self, visitor: &HtmlVisitor, result: &mut CodeGenResult) -> Result<(), Box<dyn std::error::Error>> {
    ...
    fn generate_single_file(&self, visitor: &HtmlVisitor, result: &mut CodeGenResult) -> Result<(), Box<dyn std::error::Error>> {
        let root_elements = if self.exportable_only {
            visitor.exportable_root_html_elements_by_name()
        } else {
            visitor.root_html_elements_by_name()
    ...
    fn generate_html_file(&self, component_name: &str, html_element: &str) -> Result<String, Box<dyn std::error::Error>> {
    ...
    fn generate_index_file(&self, root_elements: &HashMap<String, (String, String)>) -> Result<String, Box<dyn std::error::Error>> {
        let mut content = String::new();
