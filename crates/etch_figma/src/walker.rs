...
use figma_api::models::{
    TextNode, FrameNode, VectorNode, ComponentNode, InstanceNode, SectionNode, GroupNode,
    BooleanOperationNode, ComponentSetNode, ConnectorNode, EllipseNode, EmbedNode,
    LineNode, LinkUnfurlNode, RectangleNode, RegularPolygonNode, ShapeWithTextNode,
    SliceNode, StarNode, StickyNode, TableNode, TableCellNode, TextPathNode,
    TransformGroupNode, WashiTapeNode, WidgetNode
};
...
pub trait NodeVisitor {
    ...
    fn visit_boolean_operation(&mut self, _boolean_op: &BooleanOperationNode, _context: &NodeContext) {}
    fn visit_table(&mut self, _table: &TableNode, _context: &NodeContext) {}
    fn visit_transform_group(&mut self, _transform_group: &TransformGroupNode, _context: &NodeContext) {}
    ...
    fn visit_shape_with_text(&mut self, _shape_with_text: &ShapeWithTextNode, _context: &NodeContext) {}
