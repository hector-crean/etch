use crate::analysis::svg_container::SvgWrapperConfig;
...
pub fn create_svg_wrapper(children: Vec<JSXElementChild>, config: &SvgWrapperConfig) -> JSXElement {
...
pub fn create_mixed_container(
    ...
    overlay_attrs.push(create_attr(
        "className",
...
pub fn calculate_bounds_from_children(
